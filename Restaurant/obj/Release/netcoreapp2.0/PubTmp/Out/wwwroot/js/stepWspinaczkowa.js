(function () {
    ...
    angular
        .module('app')
        .controller('WspinaczkowaModalCtrl', WspinaczkowaModalCtrl);

    WspinaczkowaModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function WspinaczkowaModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
        ...
        $scope.restauracja = function () {
            var $lokal = 'sala wspinaczkowa';
            $email = $('input[name=email]').val();
            
            $.ajax({
                url: "/Home/Wspinaczkowa",
                type: "POST",
