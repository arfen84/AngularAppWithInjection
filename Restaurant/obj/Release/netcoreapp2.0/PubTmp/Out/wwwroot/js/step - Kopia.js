(function () {
    ...
    angular
        .module('app')
        .controller('WizardModalCtrl', WizardModalCtrl);

    WizardModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    

    function WizardModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
