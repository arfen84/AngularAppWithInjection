(function () {
    ...
    angular
        .module('app')
        .controller('EventowaModalCtrl', EventowaModalCtrl);

    EventowaModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function EventowaModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
