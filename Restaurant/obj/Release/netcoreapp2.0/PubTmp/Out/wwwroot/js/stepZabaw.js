(function () {
    ...
    angular
        .module('app')
        .controller('ZabawModalCtrl', ZabawModalCtrl);

    ZabawModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function ZabawModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
