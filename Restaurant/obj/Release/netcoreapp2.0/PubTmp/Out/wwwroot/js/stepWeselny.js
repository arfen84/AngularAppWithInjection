(function () {
    ...
    angular
        .module('app')
        .controller('WeselnyModalCtrl', WeselnyModalCtrl);

    WeselnyModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function WeselnyModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
