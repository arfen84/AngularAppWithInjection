(function () {
    ...
    angular
        .module('app')
        .controller('DomkiModalCtrl', DomkiModalCtrl);

    DomkiModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function DomkiModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
