(function () {
    ...
    angular
        .module('app')
        .controller('RekreacjaModalCtrl', RekreacjaModalCtrl);

    RekreacjaModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function RekreacjaModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
