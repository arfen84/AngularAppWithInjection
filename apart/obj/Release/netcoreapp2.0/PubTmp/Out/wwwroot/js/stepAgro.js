(function () {
    ...
    angular
        .module('app')
        .controller('AgroModalCtrl', AgroModalCtrl);

    AgroModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function AgroModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
        ...
        $scope.restauracja = function () {
            var $lokal = 'gospodarstwo agroturystyczne';
