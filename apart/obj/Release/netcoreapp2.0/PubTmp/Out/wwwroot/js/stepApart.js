(function () {
    ...
    angular
        .module('app')
        .controller('ApartModalCtrl', ApartModalCtrl);

    ApartModalCtrl.$inject = ['$scope', '$modalInstance', 'data'];

    function ApartModalCtrl($scope, $modalInstance, data) {
        $scope.data = data;
